...
DATABASE_URL = os.getenv("DATABASE_URL", "sqlite:///./tweetstack_demo.db")
...
# Modelos de base de datos simplificados (sin foreign keys externas)
class Tweet(Base):
    __tablename__ = "tweets"
    
    id = Column(Integer, primary_key=True, index=True)
    user_id = Column(String, index=True)  # Sin foreign key externa
    content = Column(Text)
